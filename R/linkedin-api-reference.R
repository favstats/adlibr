# LinkedIn Ad Library API Reference Documentation
# Based on: https://www.linkedin.com/ad-library/api/ads

#' LinkedIn Ad Library API Reference
#'
...
#' 1. Configure your LinkedIn app credentials using \code{li_auth_configure()}
#' 2. Authenticate using \code{li_auth()} to obtain an access token
#' 3. Use \code{li_query()} which automatically uses the cached token
#'
